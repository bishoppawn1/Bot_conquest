...
- `MERCHANT_SPAWNS` defines overworld doors, not exposed NPCs. Major upgrade merchants are discoveries away from the post-boss recovery route: Parts Broker is in the Wall-Climb-gated Relay Crown, Capacitor Exchange is on the Shard Gauntlet overlook, and Shell Archive is on a high Grand Exchange route. Scattered doors remain elsewhere, including the Grand Exchange damage forge.
