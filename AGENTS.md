...
- The Vault Sentinel is a six-health mini boss. Its room activates only after the player falls inside, closes a single exit gate, and awards 60 scrap when defeated. It uses a telegraphed leaping charge rather than the Heavy Core's three-move boss cycle.
