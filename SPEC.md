...
After the Abyss Warden is defeated and Wall Climb has been acquired, the Warden floor opens around a 120-unit entrance wall and a clearly readable 200-unit hatch. The route below becomes a large exploration chamber: the first landing leads to a 200-unit west climb and gallery, then a controlled drop leads to a 220-unit east climb and second gallery. Both rises exceed the basic jump. Two further controlled drops descend to the Rift Stalker floor at Y 2,550.
