...
The deep Sunken Vault becomes physically accessible once the Abyss Warden is dead and Wall Climb is owned. Opening it retracts both the old boss-floor mass and the low `vault-high` cap that previously trapped the player beneath the hatch. The replacement is a 120-unit climb lip with usable headroom and a visible 90-unit shaft; climbing the lip and dropping through the shaft reaches the first irreversible deep landing.
