...
function begin() {
  ...
  if (debugSpawn === 'boss') {
    ...
    game.player.body.expansionSlots.push({id:'auxiliary-1',part:'auxiliary',label:'AUXILIARY BAY A',efficiency:.3});game.recomputeBodyStats();game.player.lives=4;game.player.electricity=125;
