...
export class Renderer {
  ...
  drawBackground(game) {
    const {ctx}=this,sunken=game.regionId==='vault';const gradient=ctx.createLinearGradient(0,0,0,720);gradient.addColorStop(0,sunken?'#07101a':'#101924');gradient.addColorStop(1,sunken?'#020509':'#070b10');ctx.fillStyle=gradient;ctx.fillRect(0,0,1280,720);
